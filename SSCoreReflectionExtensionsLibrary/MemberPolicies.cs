...
namespace Internal.Reflection.Extensions.NonPortable
	...
	internal sealed class FieldPolicies : MemberPolicies<FieldInfo>
		{
		public override sealed IEnumerable<FieldInfo> GetDeclaredMembers (TypeInfo typeInfo)
			{
			return typeInfo.DeclaredFields;
			}

		public override sealed void GetMemberAttributes (FieldInfo member, out MethodAttributes visibility, out bool isStatic, out bool isVirtual, out bool isNewSlot)
			{
		...
		public override sealed bool AreNamesAndSignatureEqual (FieldInfo member1, FieldInfo member2)
			{
	...
	internal sealed class ConstructorPolicies : MemberPolicies<ConstructorInfo>
		{
		public override sealed IEnumerable<ConstructorInfo> GetDeclaredMembers (TypeInfo typeInfo)
			{
			return typeInfo.DeclaredConstructors;
			}

		public override sealed BindingFlags ModifyBindingFlags (BindingFlags bindingFlags)
			{
			// Constructors are not inherited.
			return bindingFlags | BindingFlags.DeclaredOnly;
			}

		public override sealed void GetMemberAttributes (ConstructorInfo member, out MethodAttributes visibility, out bool isStatic, out bool isVirtual,
		                                                 out bool isNewSlot)
			{
		...
		public override sealed bool AreNamesAndSignatureEqual (ConstructorInfo member1, ConstructorInfo member2)
			{
	...
	internal sealed class MethodPolicies : MemberPolicies<MethodInfo>
		{
		public override sealed IEnumerable<MethodInfo> GetDeclaredMembers (TypeInfo typeInfo)
			{
			return typeInfo.DeclaredMethods;
			}

		public override sealed void GetMemberAttributes (MethodInfo member, out MethodAttributes visibility, out bool isStatic, out bool isVirtual, out bool isNewSlot)
			{
			MethodAttributes methodAttributes = member.Attributes;
			visibility = methodAttributes & MethodAttributes.MemberAccessMask;
			isStatic = (0 != (methodAttributes & MethodAttributes.Static));
		...
		public override sealed bool AreNamesAndSignatureEqual (MethodInfo member1, MethodInfo member2)
			{
	...
	internal sealed class PropertyPolicies : MemberPolicies<PropertyInfo>
		{
		public override sealed IEnumerable<PropertyInfo> GetDeclaredMembers (TypeInfo typeInfo)
			{
			return typeInfo.DeclaredProperties;
			}

		public override sealed void GetMemberAttributes (PropertyInfo member, out MethodAttributes visibility, out bool isStatic, out bool isVirtual,
		                                                 out bool isNewSlot)
			{
		...
		public override sealed bool AreNamesAndSignatureEqual (PropertyInfo member1, PropertyInfo member2)
			{
			return AreNamesAndSignaturesEqual (GetAccessorMethod (member1), GetAccessorMethod (member2));
			}

		public override sealed PropertyInfo GetInheritedMemberInfo (PropertyInfo underlyingMemberInfo, Type reflectedType)
			{
	...
	internal sealed class EventPolicies : MemberPolicies<EventInfo>
		{
		public override sealed IEnumerable<EventInfo> GetDeclaredMembers (TypeInfo typeInfo)
			{
			return typeInfo.DeclaredEvents;
			}

		public override sealed void GetMemberAttributes (EventInfo member, out MethodAttributes visibility, out bool isStatic, out bool isVirtual, out bool isNewSlot)
			{
			MethodInfo accessorMethod = GetAccessorMethod (member);
			MethodAttributes methodAttributes = accessorMethod.Attributes;
			visibility = methodAttributes & MethodAttributes.MemberAccessMask;
		...
		public override sealed bool AreNamesAndSignatureEqual (EventInfo member1, EventInfo member2)
			{
			return AreNamesAndSignaturesEqual (GetAccessorMethod (member1), GetAccessorMethod (member2));
			}
		...
		private MethodInfo GetAccessorMethod (EventInfo e)
			{
			MethodInfo accessor = e.GetAddMethod ();
			return accessor;
			}
		}
	...
	internal sealed class NestedTypePolicies : MemberPolicies<TypeInfo>
		{
		public override sealed IEnumerable<TypeInfo> GetDeclaredMembers (TypeInfo typeInfo)
			{
			return typeInfo.DeclaredNestedTypes;
			}

		public override sealed void GetMemberAttributes (TypeInfo member, out MethodAttributes visibility, out bool isStatic, out bool isVirtual, out bool isNewSlot)
			{
			isStatic = true;
			isVirtual = false;
			isNewSlot = false;
		...
		public override sealed bool AreNamesAndSignatureEqual (TypeInfo member1, TypeInfo member2)
			{
